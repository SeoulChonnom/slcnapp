...
public class TripController {
	...
	public ResponseEntity<BaseResponse> createTrip(@RequestParam TripRegisterRequest tripRegisterRequest, @RequestPart MultipartFile logo, @RequestPart MultipartFile map1, @RequestPart MultipartFile map2) {
		return new ResponseEntity<>(
				BaseResponse.from(true, REGISTER_TRIP_SUCCESS_MESSAGE, tripService.registerTrip(tripRegisterRequest, logo, map1, map2)),
				HttpStatus.OK
		);
	}
}
