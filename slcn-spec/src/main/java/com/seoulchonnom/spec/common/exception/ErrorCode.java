...
public enum ErrorCode {
	...
	INSPECTION_AREA_DUPLICATED(HttpStatus.CONFLICT, INSPECTION_AREA_DUPLICATED_ERROR_MESSAGE),
	INSPECTION_VISIT_NOT_FOUND(HttpStatus.BAD_REQUEST, INSPECTION_VISIT_NOT_FOUND_ERROR_MESSAGE),
	INVALID_INSPECTION_VISIT(HttpStatus.BAD_REQUEST, INVALID_INSPECTION_VISIT_ERROR_MESSAGE),
	INSPECTION_VISIT_CONFLICT(HttpStatus.CONFLICT, INSPECTION_VISIT_CONFLICT_ERROR_MESSAGE),
	VIEWED_PROPERTY_NOT_FOUND(HttpStatus.BAD_REQUEST, VIEWED_PROPERTY_NOT_FOUND_ERROR_MESSAGE),
	INVALID_VIEWED_PROPERTY(HttpStatus.BAD_REQUEST, INVALID_VIEWED_PROPERTY_ERROR_MESSAGE),
	VIEWED_PROPERTY_CONFLICT(HttpStatus.CONFLICT, VIEWED_PROPERTY_CONFLICT_ERROR_MESSAGE),
	INSPECTION_QUESTION_NOT_FOUND(HttpStatus.BAD_REQUEST, INSPECTION_QUESTION_NOT_FOUND_ERROR_MESSAGE),
	INVALID_INSPECTION_QUESTION(HttpStatus.BAD_REQUEST, INVALID_INSPECTION_QUESTION_ERROR_MESSAGE),
	INSPECTION_QUESTION_CONFLICT(HttpStatus.CONFLICT, INSPECTION_QUESTION_CONFLICT_ERROR_MESSAGE),
	INSPECTION_ANSWER_REQUIRED(HttpStatus.BAD_REQUEST, INSPECTION_ANSWER_REQUIRED_ERROR_MESSAGE),
	INVALID_PROPERTY_ANSWER(HttpStatus.BAD_REQUEST, INVALID_PROPERTY_ANSWER_ERROR_MESSAGE),
	INVALID_INSPECTION_FILE(HttpStatus.BAD_REQUEST, INVALID_INSPECTION_FILE_ERROR_MESSAGE),
	INVALID_INSPECTION_ORDER(HttpStatus.BAD_REQUEST, INVALID_INSPECTION_ORDER_ERROR_MESSAGE);
