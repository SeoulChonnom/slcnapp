...
public class FileConstant {
	...
	public static final String AVAILABLE_PATH = "logo|map";
	public static final String EXT_REGEX_STRING = "jpg|png|jpeg|gif|svg";
	public static final String FILE_PATH_REGEX_STRING = "/(logo|map)\\/[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}.(jpg|png|jpeg|gif|svg)$";
