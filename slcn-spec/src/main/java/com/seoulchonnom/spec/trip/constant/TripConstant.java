package com.seoulchonnom.spec.trip.constant;
...
public class TripConstant {
	...
	public static final String TRIP_NOT_FOUND_ERROR_MESSAGE = "해당 나들이가 없습니다.";
	public static final String INVALID_TRIP_REGISTER_ERROR_MESSAGE = "나들이 데이터가 잘못되었습니다.";
